...
export default function Hero() {
    return (
        <main className="">
            ...
            {/* Section 1 – Hero */}
            <section className="min-h-132 flex items-center justify-center bg-gradient-to-r from-green-100 to-cyan-200 px-6">
                <div className="max-w-8xl text-center">

                    <h1 className="text-2xl font-serif md:text-6xl text-black leading-tight mb-8">
                    ...
                    <div className="flex justify-center gap-4">
                        ...
                        <Link href="/casestudy">
                            <button className="px-6 py-3 border border-blue-500 text-blue-500 rounded-lg hover:bg-gradient-to-r from-cyan-400 to-blue-500 hover:text-white transition cursor-pointer">
                                See Our Work
                            </button>
                        </Link>
                    </div>
