            ...
            <section className="min-h-132 flex items-center justify-center bg-blue-50 px-6">
                ...
                <div className="max-w-6xl w-full text-center">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-6 gap-6 ">
                        ...
                        {/* Card 1 */}
                        <div className="p-8 border hover:border-blue-500 bg-gradient-to-r from-cyan-300 to-white/50 rounded-xl shadow-sm hover:shadow-lg transition hover:-translate-y-2 cursor-pointer">
                        ...
                        {/* Card 3 */}
                        <div className="p-8 border hover:border-blue-500 bg-gradient-to-r from-cyan-300 to-white/80 rounded-xl shadow-sm hover:shadow-lg transition hover:-translate-y-2 cursor-pointer">
                            <div className="text-8xl mb-4">🎓</div>
